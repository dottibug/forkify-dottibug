...
class RecipeView extends View {
  ...
  _errorMessage = `We could not find that recipe. Try a new recipe!`;
  _message = ``;

  // adding event handlers that render recipes
  ...
  _generateMarkup() {
    ...
    return `
      ...
      <div class="recipe__ingredients">
        ...
        <ul class="recipe__ingredient-list">${this._generateMarkupIngredients()}</ul>
      </div>
      ...
      .map(ing => {
        ...
        return `
          <li class="recipe__ingredient">
            ...
            <div class="recipe__quantity">${ing.quantity === null ? '' : fracty(ing.quantity)}</div>
